...
public class CampaignsRequestRx {

    private CampaignsServiceRx service;

    public CampaignsRequestRx(@NotNull PercolateApi context) {
        this.service = new RetrofitApiFactory(context).getService(CampaignsServiceRx.class);
    }
