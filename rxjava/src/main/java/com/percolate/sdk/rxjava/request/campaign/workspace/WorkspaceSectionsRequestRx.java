...
public class WorkspaceSectionsRequestRx {

    private WorkspaceSectionsServiceRx service;

    public WorkspaceSectionsRequestRx(@NotNull PercolateApi context) {
        this.service = new RetrofitApiFactory(context).getService(WorkspaceSectionsServiceRx.class);
    }
