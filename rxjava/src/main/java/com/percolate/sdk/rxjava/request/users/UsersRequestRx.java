...
public class UsersRequestRx {

    private UsersServiceRx service;

    public UsersRequestRx(@NotNull PercolateApi context) {
        this.service = new RetrofitApiFactory(context).getService(UsersServiceRx.class);
    }
