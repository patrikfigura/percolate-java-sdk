...
public class UserRolesRequestRx {

    private UserRolesServiceRx service;

    public UserRolesRequestRx(@NotNull PercolateApi context) {
        this.service = new RetrofitApiFactory(context).getService(UserRolesServiceRx.class);
    }
