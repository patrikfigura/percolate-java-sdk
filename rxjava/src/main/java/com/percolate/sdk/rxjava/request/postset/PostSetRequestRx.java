...
public class PostSetRequestRx {

    private PostSetServiceRx service;

    public PostSetRequestRx(@NotNull PercolateApi context) {
        this.service = new RetrofitApiFactory(context).getService(PostSetServiceRx.class);
    }
