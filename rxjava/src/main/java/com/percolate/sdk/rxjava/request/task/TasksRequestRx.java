...
public class TasksRequestRx {

    private TasksServiceRx service;

    public TasksRequestRx(@NotNull PercolateApi context) {
        this.service = new RetrofitApiFactory(context).getService(TasksServiceRx.class);
    }
