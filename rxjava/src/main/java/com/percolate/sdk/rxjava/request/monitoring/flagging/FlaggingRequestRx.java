...
public class FlaggingRequestRx {

    private FlaggingServiceRx service;

    public FlaggingRequestRx(@NotNull PercolateApi context) {
        this.service = new RetrofitApiFactory(context).getService(FlaggingServiceRx.class);
    }
