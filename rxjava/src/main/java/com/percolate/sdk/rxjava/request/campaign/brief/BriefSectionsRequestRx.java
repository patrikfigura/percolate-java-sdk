...
public class BriefSectionsRequestRx {

    private BriefSectionsServiceRx service;

    public BriefSectionsRequestRx(@NotNull PercolateApi context) {
        this.service = new RetrofitApiFactory(context).getService(BriefSectionsServiceRx.class);
    }
